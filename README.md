...
[50] = function()
    ...
    return {
        Name = "Red",
        Accent = Color3.fromRGB(255, 0, 0),  -- Red accent color
        AcrylicMain = Color3.fromRGB(255, 0, 0),  -- Red main acrylic color
        AcrylicBorder = Color3.fromRGB(120, 0, 0),  -- Dark red acrylic border color
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 0, 0), Color3.fromRGB(255, 0, 0)),  -- Red gradient
        AcrylicNoise = 0.96,
        TitleBarLine = Color3.fromRGB(160, 0, 0),  -- Dark red title bar line color
        Tab = Color3.fromRGB(90, 0, 0),  -- Dark red tab color
        Element = Color3.fromRGB(255, 0, 0),  -- Red element color
        ElementBorder = Color3.fromRGB(180, 0, 0),  -- Dark red element border color
        InElementBorder = Color3.fromRGB(150, 0, 0),  -- Darker red inner element border color
        ElementTransparency = 0.65,
        ToggleSlider = Color3.fromRGB(40, 0, 0),  -- Dark red toggle slider color
        ToggleToggled = Color3.fromRGB(255, 0, 0),  -- Red color for toggled state
        SliderRail = Color3.fromRGB(40, 0, 0),  -- Dark red slider rail color
        DropdownFrame = Color3.fromRGB(255, 0, 0),  -- Red dropdown frame color
        DropdownHolder = Color3.fromRGB(240, 0, 0),  -- Dark red dropdown holder color
        DropdownBorder = Color3.fromRGB(200, 0, 0),  -- Dark red dropdown border color
        DropdownOption = Color3.fromRGB(150, 0, 0),  -- Dark red dropdown option color
        Keybind = Color3.fromRGB(120, 0, 0),  -- Dark red keybind color
        Input = Color3.fromRGB(255, 0, 0),  -- Red input color
        InputFocused = Color3.fromRGB(100, 0, 0),  -- Dark red input focused color
        InputIndicator = Color3.fromRGB(80, 0, 0),  -- Dark red input indicator color
        Dialog = Color3.fromRGB(255, 0, 0),  -- Red dialog color
        DialogHolder = Color3.fromRGB(240, 0, 0),  -- Dark red dialog holder color
        DialogHolderLine = Color3.fromRGB(228, 0, 0),  -- Dark red dialog holder line color
        DialogButton = Color3.fromRGB(255, 0, 0),  -- Red dialog button color
        DialogButtonBorder = Color3.fromRGB(190, 0, 0),  -- Dark red dialog button border color
        DialogBorder = Color3.fromRGB(140, 0, 0),  -- Dark red dialog border color
        DialogInput = Color3.fromRGB(250, 0, 0),  -- Dark red dialog input color
        DialogInputLine = Color3.fromRGB(160, 0, 0),  -- Dark red dialog input line color
        Text = Color3.fromRGB(0, 0, 0),  -- Black text color
        SubText = Color3.fromRGB(40, 0, 0),  -- Dark red subtext color
        Hover = Color3.fromRGB(50, 0, 0),  -- Dark red hover color
        HoverChange = 0.16
    }
end
